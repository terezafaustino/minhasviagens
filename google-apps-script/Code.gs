...
function saveState(state) {
  ...
  replaceRows('Passagens',['viagem_id','trecho','data','companhia','custo','status','pagamento','milhas','programa_milhas','taxas'],state.trips.flatMap(t=>t.flights.map(x=>[t.id,...x])));
